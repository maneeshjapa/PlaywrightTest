...
exports.getPlaywrightEnv = (basicEnv = 'node') => {
    ...
    return class PlaywrightEnvironment extends RootEnv {
        ...
        async setup() {
            ...
            const { connectOptions, collectCoverage, exitOnPageError, selectors, launchType, debugOptions, skipInitialization, } = this._jestPlaywrightConfig;
            if (wsEndpoint) {
            ...
            if (browserType === constants_1.FIREFOX && contextOptions.isMobile) {
            ...
            this.global.jestPlaywright = {
                configSeparateEnv: async (config, isDebug) => {
